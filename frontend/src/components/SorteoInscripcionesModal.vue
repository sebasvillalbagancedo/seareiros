    ...
    <div class="modal modal-wide">
      ...
      <div class="modal-body">
        ...
        <p v-if="!cargando && !inscripcionesTodas.length" class="mensaje">
          No hay inscripciones en este sorteo.
        </p>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      inscripcionesTodas() {
        return useSorteosStore().inscripcionesTodas
      },
    ...
    async created() {
      this.cargando = true
      await Promise.all([
        useSorteosStore().cargarInscripciones(this.sorteo.id),
