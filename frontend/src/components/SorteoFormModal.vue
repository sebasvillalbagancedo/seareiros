        ...
        <div class="modal-body">
          ...
          <div class="fila-campos">
            <div class="campo">
              ...
              <input v-model="form.fecha_nacimiento_maxima" type="date" placeholder="Edad mínima" />
            </div>
            <div class="campo">
              <label>Fecha nacimiento mínima</label>
              <input v-model="form.fecha_nacimiento_minima" type="date" placeholder="Edad máxima" />
            </div>
          </div>

          <div class="campo">
            <label>Fecha alta máxima</label>
            <input v-model="form.fecha_alta_maxima" type="date" placeholder="Antigüedad mínima" />
          </div>
        </div>
