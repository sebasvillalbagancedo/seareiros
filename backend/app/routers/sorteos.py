...
from app.services.sorteos import (
    ...
    cancelar_inscripcion, resolver_sorteo, contar_inscritos
)
...
def _inscripcion_to_output(
    ...
    return InscripcionOutput(
        ...
        usuario_cancelacion=str(inscripcion.usuario_cancelacion)
                            if inscripcion.usuario_cancelacion else None,
...
def get_sorteos_list_ep(
    ...
    """Listado de sorteos. Todos los usuarios autenticados pueden ver el listado de sorteos."""
