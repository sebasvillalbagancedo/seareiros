...
class ChatCreate(BaseModel):
    ...
    def validar_campos(self):
        if self.tipo_acceso not in ('libre', 'restringido'):
            raise ValueError("tipo_acceso debe ser 'libre' o 'restringido'")
        if self.modalidad not in ('bidireccional', 'canal'):
            raise ValueError("modalidad debe ser 'bidireccional' o 'canal'")
        if self.visibilidad not in ('visible', 'oculta'):
            raise ValueError("visibilidad debe ser 'visible' u 'oculta'")
        return self
